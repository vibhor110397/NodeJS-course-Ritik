...
const createSendToken = (user, statusCode, res) => {
  ...
  // Remove password from the postman output
...
exports.forgotPassword = catchAsync(async (req, res, next) => {
  // 1) Get user based on Postd email
...
exports.resetPassword = catchAsync(async (req, res, next) => {
  ...
  if (!user) {
    return next(new AppError('Invalid or expaired  Token', 400));
  }
  ...
  // 3)update changePassword property for the user and log the user in
